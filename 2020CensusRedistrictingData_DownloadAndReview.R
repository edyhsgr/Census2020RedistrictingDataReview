...
## -----------------------------
#header_file_path <- paste(text=c(state,"2020.pl/",state,"geo2020.pl"),collapse="")
#part1_file_path  <- paste(text=c(state,"2020.pl/",state,"000012020.pl"),collapse="")
#part2_file_path  <- paste(text=c(state,"2020.pl/",state,"000022020.pl"),collapse="")
#part3_file_path  <- paste(text=c(state,"2020.pl/",state,"000032020.pl"),collapse="")
#
## -----------------------------
## Import the data
## -----------------------------
...
#####END of US Census Bureau-provided code#####

	##Select fields of interest
	Selection<-combine[c("SUMLEV","STATE","COUNTY","NAME",field)]
